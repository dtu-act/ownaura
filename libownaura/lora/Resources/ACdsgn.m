...
% % Output Variables
% % 
% % Ba is an array of filter coefficients for A-weighting.   
% %           There are three cells and the filter function is applied
% %           iteratively to each cell of filter coefficiients.  
% % 
% % Aa is an array of filter coefficients for A-weighting. 
% % 
% % Bc is an array of filter coefficients for C-weighting. 
% % 
% % Ac is an array of filter coefficients for C-weighting. 
% % 
% % **********************************************************************
% 
% 
